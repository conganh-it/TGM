...
/// See alpr::AlprStream::set_plate_groups_consider_trajectory()
void alprstream_set_plate_groups_consider_trajectory(ALPRSTREAM* instance, int plate_groups_consider_trajectory);
