...
class AlprStream:
    ...
    def __init__(self, frame_queue_size, use_motion_detection=1):
        ...
        self._set_plate_groups_consider_trajectory_func = self._alprstreampy_lib.alprstream_set_plate_groups_consider_trajectory
        self._set_plate_groups_consider_trajectory_func.restype = ctypes.c_void_p
        self._set_plate_groups_consider_trajectory_func.argtypes = [ctypes.c_int]
    ...
    def set_plate_groups_consider_trajectory(self, plate_groups_consider_trajectory):
        """Set the flag for sanity checking plate reads based on group plate trajectories
        :param plate_groups_consider_trajectory: True is enable, False is disable the function.  
        :return: None
        """
        is_enabled_int = 0
        if plate_groups_consider_trajectory:
            is_enabled_int = 1

        self._set_plate_groups_consider_trajectory_func(self._alprstream_pointer, is_enabled_int)  
